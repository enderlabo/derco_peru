<template>
  <div class="panel-filters-to-catalog">
    ...
    <b-card class="card-filters-car">
        ...
        <b-collapse id="accordion-category" role="tabpanel">
          <template v-slot:default="{}">
            <b-card-body class="p-2 card-body-filters-cards">
              ...
              >
                <b-form-checkbox
                  v-for="(option, index) in filtersApi.carClasses"
                  :key="index"
      ...
      <b-button pill block class="btn-red-filter-cars" @click="search({})">
        APLICAR FILTROS
      </b-button>
    </b-card>
  </div>
...
export default {
  ...
  computed: {
    ...
    selectedCategory: {
      get() {
        return this.$store.state.models.bodySearch.filters.carClasses
      },
      set(value) {
        const data = {
          key: 'carClasses',
    ...
    selectedModel: {
      get() {
        return this.$store.state.models.bodySearch.filters.models
      },
      set(value) {
        const data = {
          key: 'models',
    ...
    selectedBrand: {
      get() {
        return this.$store.state.models.bodySearch.filters.brands
      },
      set(value) {
        const data = {
          key: 'brands',
  ...
  methods: {
    ...mapActions({
      addBodySearchData: 'models/addBodySearchData',
